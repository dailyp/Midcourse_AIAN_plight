...
ui <- navbarPage(title = "MMIWG Crisis", theme = shinytheme("superhero"),
                 ...
                 tabPanel("Missing", 
                          sidebarLayout(
                            ...
                            # Main panel for displaying Missing persons outputs ----
                            mainPanel(
                 ...
                 tabPanel("Map", 
                         # sidebarLayout(
                         #   sidebarPanel(
                              # Input: U.S. maps showing aian female viol deaths 
                              # & missing vs aian population 
                            
                          #  ),
                            
                            # Main panel for displaying map outputs
                            mainPanel(
